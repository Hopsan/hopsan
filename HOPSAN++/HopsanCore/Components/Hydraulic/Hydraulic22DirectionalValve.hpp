...
namespace hopsan {
    ...
    private:
        ...
        double *mpND_p1, *mpND_q1, *mpND_c1, *mpND_Zc1, *mpND_p2, *mpND_q2, *mpND_c2, *mpND_Zc2, *mpND_xvin;
    ...
    public:
        ...
        {
            mTypeName = "Hydraulic22DirectionalValve";
            Cq = 0.67;
            d = 0.01;
            f = 1.0;
            xvmax = 0.01;
        ...
        void simulateOneTimestep()
        {
            ...
            Kc = Cq*f*pi*d*xnom*sqrt(2.0/890.0);
