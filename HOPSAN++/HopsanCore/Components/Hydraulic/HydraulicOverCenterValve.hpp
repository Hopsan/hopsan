...
//!
//$Id: HydraulicOverCenterValve.hpp 3227 2011-08-10 14:53:33Z bjoer $
...
namespace hopsan {
    ...
    {
    private:
        double x0, x0max, pref, tao, Kcs, Kcf, Cs, Cf, pnom, qnom, ph, arat;
        double mPrevX0;
    ...
    public:
        ...
        HydraulicOverCenterValve() : ComponentQ()
        {
            pref = 2000000;
            tao = 0.01;
            Kcs = 0.00000001;
            ...
            registerParameter("a_ratio", "Area ratio", "[-]", arat);
        }
