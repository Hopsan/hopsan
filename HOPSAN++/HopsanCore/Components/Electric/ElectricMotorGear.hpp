...
public:
     ...
     {
        std::cout << "running ElectricMotorGear creator" << std::endl;
        return new ElectricMotorGear("MotorGear");
     }
...
NodeMechanicRotational::CHARIMP);
        ...
        mpND_gearRatio=getSafeNodeDataPtr(mpPgearRatio, NodeSignal::VALUE);
    ...
    void simulateOneTimestep()
     {
        ...
        for(iter=1;iter<=mNoiter;iter++)
        {
         ...
         //Differential-algebraic system of equation parts
          delayParts1[1] = (-(gearRatio*iel2*mKe*mTimestep) + \
mTimestep*tormr1 - 2*mJL*wmr1 - 2*Power(gearRatio,2)*mJm*wmr1 + \
mBL*mTimestep*wmr1 + Power(gearRatio,2)*mBm*mTimestep*wmr1 + \
gearRatio*mTimestep*mTm0*limit(wmr1/mwc,-1.,1.) + \
mmyfric*mTimestep*tormr1*limit(wmr1/mwc,-1.,1.))/(2*mJL + \
2*Power(gearRatio,2)*mJm + mBL*mTimestep + Power(gearRatio,2)*mBm*mTimestep);
          delayParts2[1] = (-2*thetamr1 - mTimestep*wmr1)/2.;
