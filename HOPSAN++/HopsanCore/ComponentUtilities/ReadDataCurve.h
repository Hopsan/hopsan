...
//!
//! @file   ReadDataCurve.h
//! @author Björn Eriksson <bjorn.eriksson@liu.se>
//! @date   2011-04-12
//!
//! @brief Contains the Core Utility ReadDataCurve class
//!
//$Id$
...
namespace hopsan {
    ...
    class DLLIMPORTEXPORT ReadDataCurve
    {
    public:
        ReadDataCurve(std::string filename = "Book1.csv",
...
#endif // READDATACURVE_H_INCLUDED
