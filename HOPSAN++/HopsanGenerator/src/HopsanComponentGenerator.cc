...
void HopsanComponentGenerator::generateToSimulink(QString savePath, hopsan::ComponentSystem *pSystem, bool disablePortLabels, int compiler)
{
    ...
    QFile wrapperTemplateFile(":templates/fmuLibTemplate.cc");
    ...
    {
        j = tot+i;
        wrapperReplace11.append("        pComponentSystem->getSubComponent(\"" + inputComponents.at(i) + "\")->getPort(\"" + inputPorts.at(i) + "\")->writeNode(0, input" + i + ");\n");
    }
