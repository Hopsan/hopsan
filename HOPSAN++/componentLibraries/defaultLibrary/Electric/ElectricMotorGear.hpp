...
//==This code has been autogenerated using Compgen==
        //Add constants/parameters
            addConstant("Ke", "emf constant", "V/rpm", 0.13,Ke);
            addConstant("Ra", "motor resistance", "Ohm", 0.04,Ra);
            addConstant("Tm0", "zero speed friction of motor", "Nm", 0.,Tm0);
            addConstant("wc", "Friction speed (for numerics)", "rad/s", \
1.,wc);
            addConstant("Bm", "Visc. fric. coeff., motor", "Ns/m", \
0.0012,Bm);
            addConstant("Jm", "Moment of inertia, motor", "kg m^2", 0.1,Jm);
            addConstant("BL", "Visc. fric. coeff., motor", "Ns/m", 0.,BL);
            addConstant("JL", "Moment of inertia, motor", "kg m^2", 1,JL);
            addConstant("myfric", "friction. coeff. of gear (at output)", "", \
0.01,myfric);
