...
(1/resistance)","A/V",0.,&mpiref);
        ...
        //Add inputParammeters to the component
            addInputVariable("resist", "&mploss resistans (at 1)", "ohm", \
0.01,&mpresist);
            addInputVariable("wf", "&mpcontroller break frequency", "rad/s", \
10.,&mpwf);
            addInputVariable("umin", "&mpminimum voltage difference", "V", \
1,&mpumin);
            addInputVariable("imax", "&mpi max limit", "A", 10000.,&mpimax);
            addInputVariable("imin", "&mpi min limit", "A", 0.01,&mpimin);
