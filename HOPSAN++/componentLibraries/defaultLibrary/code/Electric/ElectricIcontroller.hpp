    ...
    void initialize()
     {
        ...
        //Initialize delays
        delayParts1[1] = (iref*mTimestep*mwf*uel1 - iref*mTimestep*mwf*uel2 - \
2*iel1*limit(uel1 - uel2,mumin,mumax) + iel1*mTimestep*mwf*limit(uel1 - \
uel2,mumin,mumax))/(2*limit(uel1 - uel2,mumin,mumax) + \
mTimestep*mwf*limit(uel1 - uel2,mumin,mumax));
    ...
    void simulateOneTimestep()
     {
        ...
        for(iter=1;iter<=mNoiter;iter++)
        {
         ...
         //Differential-algebraic system of equation parts
          ...
          systemEquations[0] =iel1 + (iref*mTimestep*mwf*(uel1 - uel2))/((2 + \
mTimestep*mwf)*limit(uel1 - uel2,mumin,mumax)) + delayedPart[1][1];
...
limit(uel1,mumin,mumax)))/limit(uel2,mumin,mumax);
          ...
          jacobianMatrix[0][2] = -((iref*mTimestep*mwf*(uel1 - \
uel2)*dxLimit(uel1 - uel2,mumin,mumax))/((2 + mTimestep*mwf)*Power(limit(uel1 \
- uel2,mumin,mumax),2))) + (iref*mTimestep*mwf)/((2 + \
mTimestep*mwf)*limit(uel1 - uel2,mumin,mumax));
          jacobianMatrix[0][3] = (iref*mTimestep*mwf*(uel1 - \
uel2)*dxLimit(uel1 - uel2,mumin,mumax))/((2 + mTimestep*mwf)*Power(limit(uel1 \
- uel2,mumin,mumax),2)) - (iref*mTimestep*mwf)/((2 + \
mTimestep*mwf)*limit(uel1 - uel2,mumin,mumax));
