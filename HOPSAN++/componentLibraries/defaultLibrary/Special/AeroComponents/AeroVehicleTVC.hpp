...
nts\AeroVehicleTVC.hpp
//! @author Petter Krus <petter.krus@liu.se>
//! @date Mon 13 May 2013 18:38:22
...
//==This code has been autogenerated using Compgen==
        //Add constants/parameters
            ...
            addConstant("Ctvc", "hinge ciefficient TVC", "m/rad", 0.1,Ctvc);
            addConstant("CLalphabh", "L. slope c. body h", "", 2.,CLalphabh);
            addConstant("CLalphabv", "L. slope c. body v", "", 2.,CLalphabv);
            addConstant("hthrust0", "engine vert. pos", "", 0.,hthrust0);
            addConstant("Ix", "Inertia moment", "kgm2", 1000.,Ix);
            addConstant("Ixz", "Inertia moment", "kgm2", 500.,Ixz);
            addConstant("Iy", "Inertia moment", "kgm2", 3000.,Iy);
            addConstant("Iz", "Inertia moment", "kgm2", 3000.,Iz);
            addConstant("Me", "Empty weight", "kg", 5000.,Me);
            addConstant("Sbh", "norm. hor. proj. area", "", 5,Sbh);
            addConstant("Sbv", "norm.body vert. proj. area", "", 5,Sbv);
            addConstant("xbach", "body ac. hor.", "m", 8.5,xbach);
            addConstant("xbacv", "body ac vert.", "m", 8.5,xbacv);
            addConstant("xbcge", "body cg", "m", 6.,xbcge);
            addConstant("xcargo", "cargo pos.", "m", 6.,xcargo);
            addConstant("xfuel", "", "m", 6.,xfuel);
            addConstant("xeng", "engine thrust centre position", "m", \
0.,xeng);
            addConstant("yeng", "engines off. from center", "m", 0.,yeng);
