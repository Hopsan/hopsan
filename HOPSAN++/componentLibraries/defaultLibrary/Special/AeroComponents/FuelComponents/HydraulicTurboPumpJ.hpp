#ifndef HYDRAULICTURBOPUMPJ_HPP_INCLUDED
#define HYDRAULICTURBOPUMPJ_HPP_INCLUDED
...
//!
//! @file HydraulicTurboPumpJ.hpp
//! @author Petter Krus <petter.krus@liu.se>
//! @date Sun 26 May 2013 00:28:33
...
class HydraulicTurboPumpJ : public ComponentQ
{
private:
     double kl;
     double b;
...
public:
     ...
     {
        return new HydraulicTurboPumpJ();
     }
...
//==This code has been autogenerated using Compgen==
        //Add constants/parameters
            addConstant("kl", "Flow loss koeff.", "", 0.1,kl);
            addConstant("b", "outlet axial width", "m", 0.01,b);
            addConstant("d", "Diameter", "m", 0.3,d);
            addConstant("beta2", "Outlet flow angle", "rad", 0.3,beta2);
...
#endif // HYDRAULICTURBOPUMPJ_HPP_INCLUDED
