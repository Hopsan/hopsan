...
//! @date Mon 30 Sep 2013 13:25:32
//! @brief Flight dynamics model of super-sonic aircraft
//! @ingroup AeroComponents
//!
//==This code has been autogenerated using Compgen==
//from 
/*{, C:, HopsanTrunk, HOPSAN++, CompgenModels}/AeroAircraft6DOFSSDLc.nb*/
...
vM))/(dM*vM)))) - (smc*(CLde1*thetaar1 + CLde12*thetaar12 + CLift(Alpha*dah1 \
- ia1,CLalpha1e,ap1,an1,awp1,awn1)/2.))/(4.*(1 + Power(en,(-2*(v - \
vM))/(dM*vM)))) + CMoment(Alpha*dah1 - ia1,Cm01,Cmfs1,ap1,an1,awp1,awn1)) + \
