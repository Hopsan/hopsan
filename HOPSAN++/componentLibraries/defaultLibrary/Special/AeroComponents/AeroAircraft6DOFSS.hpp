...
//! @date Mon 9 Sep 2013 21:21:23
//! @brief Flight dynamics model of super-sonic aircraft
//! @ingroup AeroComponents
//!
//==This code has been autogenerated using Compgen==
//from 
/*{, C:, HopsanTrunk, HOPSAN++, CompgenModels}/AeroAircraft6DOFSSDL.nb*/
...
thrustr*Cos(deythrustr)*Sin(dezthrustr);
        Lb = (-0.12249999999999998*qpress*(AR1*CLalpha1e*Power(S1,2) + \
AR2*CLalpha2e*Power(S2,2))*(Pb + wturbx))/(0.1 + v) + rc1*rc2*((Liftl1 - \
...
ia1,CLalpha1e,ap1,an1,awp1,awn1)/2.))/(4.*(1 + Power(en,(-2*(v - \
