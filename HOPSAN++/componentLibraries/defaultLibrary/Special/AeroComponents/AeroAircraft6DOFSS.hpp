...
//! @date Wed 3 Jul 2013 09:54:21
//! @brief Flight dynamics model of super-sonic aircraft
//! @ingroup AeroComponents
//!
//==This code has been autogenerated using Compgen==
//from 
/*{, C:, HopsanTrunk, HOPSAN++, CompgenModels}/AeroAircraft6DOFSSD.nb*/
...
0.0045,&mpCd0fin);
            addInputVariable("CdW0", "Wave drag coef.", "", 0.015,&mpCdW0);
...
thetaar2,CLalpha2,ap2,an2,awp2,awn2))/2.;
        ...
        Dragb = qpress*((CdW0*S1)/(1 + Power(en,(-2*(v - vM))/(dM*vM))) + \
Cd0b*Sbh);
...
Cmde12*thetaal12 - Cmde1*thetaar1 - Cmde12*thetaar12 - \
(Sqrt(S1/AR1)*(CLde1*thetaal1 + CLde12*thetaal12 + CLift(Alpha*dah1 - \
ia1,CLalpha1,ap1,an1,awp1,awn1)/2.))/(4.*(1 + Power(en,(-2*(v - \
vM))/(dM*vM)))) - (Sqrt(S1/AR1)*(CLde1*thetaar1 + CLde12*thetaar12 + \
CLift(Alpha*dah1 - ia1,CLalpha1,ap1,an1,awp1,awn1)/2.))/(4.*(1 + \
Power(en,(-2*(v - vM))/(dM*vM)))) + CMoment(Alpha*dah1 - \
...
CLalphabh*Sbh*Sin(Alpha);
          Cd1 = Cd01 + CdW0/(1 + Power(en,(-2*(v - vM))/(dM*vM))) + \
