...
//==This code has been autogenerated using Compgen==
        //Add constants/parameters
            addConstant("dp", "Propeller diameter", "m", 1.,dp);
            addConstant("b1", "Propeller thrust coefficient", "m", 0.2,b1);
            addConstant("b2", "Propeller thrust coefficient", "m", 0.2,b2);
            addConstant("g1", "Propeller torque coefficient", "m", 0.205,g1);
            addConstant("g2", "Propeller torque coefficient", "m", 0.2,g2);
            addConstant("ct0", "Propeller torque coefficient", "m", \
0.12,ct0);
            addConstant("cp0", "Propeller torque coefficient", "m", \
0.08,cp0);
            addConstant("k", "exponent for transition", "", 4,k);
...
0.15915494309189535*dp*wmr1)));
          ...
          //Jacobian matrix
          jacobianMatrix[0][0] = 1 + 0.*Power(1/(Power(1/ct0,k) + \
Power(Abs(b1 - (1.*b2*Up)/(0.00001*dp + \
