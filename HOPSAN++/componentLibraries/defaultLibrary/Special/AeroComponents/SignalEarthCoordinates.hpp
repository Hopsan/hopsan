...
57.2958*mTimestep*timecomp*vxcg*SecL(0.0174533*lattitude)))/R;
...
(28.6479*mTimestep*timecomp*vxcg*SecL(0.0174533*lattitude))/R;
...
delayedPart[3][1];
          ...
          jacobianMatrix[1][0] = \
(-0.5*mTimestep*timecomp*vxcg*DxSecL(0.0174533*lattitude))/R;
