...
//==This code has been autogenerated using Compgen==
        //Add constants/parameters
            addConstant("y10", "treashold variable 1", "", 0.02,y10);
            addConstant("y20", "treashold variable 2", "", 0.02,y20);
            addConstant("y30", "treashold variable 3", "", 0.02,y30);
            addConstant("thau", "filter time constant 2", "sec", 1.,thau);
