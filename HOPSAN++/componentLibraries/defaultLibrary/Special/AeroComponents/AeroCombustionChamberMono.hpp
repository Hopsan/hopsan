...
//==This code has been autogenerated using Compgen==
        ...
        //Add inputParammeters to the component
            addInputVariable("Vc", "&mpChamber volume", " ", 1000.,&mpVc);
            addInputVariable("R", "&mpGas constant", "", 287,&mpR);
            addInputVariable("cv", "&mpHeat capacity", "", 718,&mpcv);
            addInputVariable("vfuel", "&mpExhaust speed", "m/s", \
1000.,&mpvfuel);
            addInputVariable("ethap", "&mpEffectivness", "", 0.9,&mpethap);
            addInputVariable("rhofuel", "&mpExhaust speed", "kg/m3", \
900.,&mprhofuel);
            addInputVariable("As", "&mpmin effective area", "m2", \
0.01,&mpAs);
            addInputVariable("Med", "&mpDesign exit Mach", "", 2.5,&mpMed);
            addInputVariable("alpha", "&mpDamp. factor", "1/s ", \
0.,&mpalpha);
