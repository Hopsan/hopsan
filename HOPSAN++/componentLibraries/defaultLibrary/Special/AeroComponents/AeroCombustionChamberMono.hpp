...
gam)))*As*Power(1 + gam,(1 + gam)/(2 - 2*gam))*pc*Sqrt(gam/R))/Sqrt(1 + \
Tc),0.,1.e9);
...
2*gam))*pc*Sqrt(gam/R)*dxLimit((Power(2,(1 + gam)/(2.*(-1 + gam)))*As*Power(1 \
+ gam,(1 + gam)/(2 - 2*gam))*pc*Sqrt(gam/R))/Sqrt(1 + Tc),0.,1.e9))/Power(1 + \
Tc,1.5);
