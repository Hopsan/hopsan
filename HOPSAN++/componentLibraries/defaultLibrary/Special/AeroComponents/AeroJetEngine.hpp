...
//==This code has been autogenerated using Compgen==
        //Add constants/parameters
            addConstant("thrustmax", "Max thrust", "N", 5000.,thrustmax);
            addConstant("SFC", "Nominal thrust specific fuel consumption", \
"kg/(N s)", 0.0000171,SFC);
            addConstant("BR", "Bypass ratio", "", 2,BR);
            addConstant("thau", "Engine time constant", "s", 5.,thau);
            addConstant("Cspeed", "thrust-speed coefficient", "", 1.,Cspeed);
