...
0.7,&mpap2);
            addInputVariable("AR1", "&mpAspect ratio 1", "", 2.24,&mpAR1);
            addInputVariable("AR2", "&mpAspect rati 2o", "", 2.2,&mpAR2);
...
0.1,&mpCLde1);
            addInputVariable("CLde2", "&mpCtrl surface coef 1", "", \
0.515,&mpCLde2);
...
"", 0.1,&mprcfin0);
            addInputVariable("S1", "&mpwing area 1", "m2", 40.,&mpS1);
            addInputVariable("S20", "&mpnorm. wing area 2", "", 0.5,&mpS20);
...
2,&mpxbacv0);
            addInputVariable("xbcge0", "&mpnorm. body cg", " ", \
1.4,&mpxbcge0);
            addInputVariable("xcargo0", "&mpnorm. cargo pos.", " ", \
1.4,&mpxcargo0);
            addInputVariable("xfuel0", "&mp", " ", 1.4,&mpxfuel0);
