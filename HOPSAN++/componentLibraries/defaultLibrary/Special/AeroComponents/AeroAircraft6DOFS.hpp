...
z","rad/s",0.,&mpwturbz);
        ...
        //Add inputParammeters to the component
            ...
            addInputVariable("AR1", "Aspect ratio 1", "", 2.24,&mpAR1);
            addInputVariable("AR2", "Aspect rati 2o", "", 2.2,&mpAR2);
            addInputVariable("ARfin", "Aspect ratio fin", "", 0.58,&mpARfin);
...
0.1,&mpCLde1);
            addInputVariable("CLde2", "Ctrl surface coef 1", "", \
0.515,&mpCLde2);
...
0.06,&mpIy0);
            addInputVariable("Iz0", "Inertia moment", " ", 0.08,&mpIz0);
...
0.1,&mprcfin0);
            addInputVariable("S1", "wing area 1", "m2", 40.,&mpS1);
            addInputVariable("S20", "norm. wing area 2", "", 0.5,&mpS20);
...
2,&mpxbacv0);
            addInputVariable("xbcge0", "norm. body cg", " ", 1.4,&mpxbcge0);
            addInputVariable("xcargo0", "norm. cargo pos.", " ", \
1.4,&mpxcargo0);
            addInputVariable("xfuel0", "", " ", 1.4,&mpxfuel0);
...
Power(vturbz + Wb,2)));
        mass = Mcargo + Med + Mfuel;
        xbcg = (Med*xbcge + Mcargo*xcargo + Mfuel*xfuel)/mass;
...
//==This code has been autogenerated using Compgen==
          ...
          cal2 = CLde2*lc2*qpress*S2*(Alpha + thetaal2);
          car2 = CLde2*lc2*qpress*S2*(Alpha + thetaar2);
...
(S2*(CLde2*thetaal2 + CLde2*thetaar2 + CLift(Alpha*dah2 - \
ia2,CLalpha2,ap2,an2,awp2,awn2)))/S1 + (CLalphabh*Sbh*Sin(Alpha))/S1;
...
thetaar2,AR2,e2,CLalpha2,ap2,an2,awp2,awn2)/2.))/S1;
          ...
          Zcal2 = CLde2*lc2*mTimestep*qpress*S2;
          Zcar2 = CLde2*lc2*mTimestep*qpress*S2;
        }
