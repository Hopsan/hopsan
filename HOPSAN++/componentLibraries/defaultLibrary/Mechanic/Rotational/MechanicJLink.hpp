...
//==This code has been autogenerated using Compgen==
        //Add constants/parameters
            addConstant("JL", "Equivalent inertia at node 2", "kgm2", 1.,JL);
            addConstant("BL", "Visc friction coeff. at node 2", "Ns/rad", \
1.,BL);
            addConstant("link", "Link length x1/sin(thetarot2)", "", \
0.1,link);
            addConstant("x0", "x position for zero angle", "", 0.1,x0);
            addConstant("theta0", "link angle for zero angle", "", \
0.1,theta0);
            addConstant("thetamin", "Min angle", "rad", -1.05,thetamin);
            addConstant("thetamax", "Max angle", "rad", 1.05,thetamax);
