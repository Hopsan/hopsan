...
//==This code has been autogenerated using Compgen==
        //Add constants/parameters
            ...
            addConstant("xp0", "Stroke pos at zero angle", "m", 0.5,xp0);
            addConstant("Lever", "Lever", "m", 0.5,Lever);
            addConstant("Cip", "Leak coeff.", "m3/(s Pa)", 0.,Cip);
            addConstant("Bp", "Visc. friction coeff.", "N/m/s", 0.,Bp);
            addConstant("JL", "Inertia", "kg m^2", 1000.,JL);
            addConstant("BL", "Viscous friction coefficient of load", "Nm s", \
0.,BL);
            addConstant("KL", "Stiffness coefficient of load", "Nm", 0.,KL);
            addConstant("thetamin", "Limitation on stroke", "rad", \
-0.5,thetamin);
            addConstant("thetamax", "Limitation on stroke", "rad", \
0.5,thetamax);
