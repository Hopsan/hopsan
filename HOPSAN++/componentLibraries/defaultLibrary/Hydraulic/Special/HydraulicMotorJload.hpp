...
//==This code has been autogenerated using Compgen==
        ...
        //Add inputParammeters to the component
            addInputVariable("Dm", "&mpDisplacement", "m3", \
0.000049999999999999996,&mpDm);
            addInputVariable("Cim", "&mpLeak coeff.", "m3/(s Pa)", \
0.,&mpCim);
            addInputVariable("Bm", "&mpVisc. friction coeff.", "N/m/s", \
0.,&mpBm);
            addInputVariable("Jm", "&mpMoment of inertia", "kg", 0.1,&mpJm);
