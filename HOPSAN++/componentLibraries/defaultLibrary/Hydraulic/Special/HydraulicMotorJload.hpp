...
//==This code has been autogenerated using Compgen==
        ...
        //Initialize delays
        delayParts1[1] = (0.25*(-0.31831*Dm*Power(mTimestep,2)*p1 + \
0.31831*Dm*Power(mTimestep,2)*p2 - 8.*Jm*thetam1 + \
2.*Power(mTimestep,2)*torm1 + 2.*Bm*Power(mTimestep,2)*wm1))/Jm;
        mDelayedPart11.initialize(mNstep,delayParts1[1]);
        delayParts1[2] = (0.25*(-0.159155*Dm*Power(mTimestep,2)*p1 + \
0.159155*Dm*Power(mTimestep,2)*p2 + 4.*Jm*thetam1 + Power(mTimestep,2)*torm1 \
+ Bm*Power(mTimestep,2)*wm1))/Jm;
    ...
    void simulateOneTimestep()
     {
        ...
        for(iter=1;iter<=mNoiter;iter++)
        {
         ...
         //Differential-algebraic system of equation parts
          ...
          systemEquations[0] =thetam1 + (Power(mTimestep,2)*(-0.0397887*Dm*p1 \
+ 0.0397887*Dm*p2 + 0.25*torm1 + 0.25*Bm*wm1))/Jm + delayedPart[1][1] + \
delayedPart[1][2];
...
torm1))/(2.*Jm + Bm*mTimestep) + wm1 + delayedPart[2][1];
          ...
          systemEquations[3] =p1 + (-c1 + q2*Zc1)*onPositive(p1);
          systemEquations[4] =p2 - (c2 + q2*Zc2)*onPositive(p2);
          systemEquations[5] =-cm1 + torm1 - wm1*Zcm1;

          //Jacobian matrix
          jacobianMatrix[0][0] = 1;
          jacobianMatrix[0][1] = (0.25*Bm*Power(mTimestep,2))/Jm;
          jacobianMatrix[0][2] = 0;
          jacobianMatrix[0][3] = (-0.0397887*Dm*Power(mTimestep,2))/Jm;
          jacobianMatrix[0][4] = (0.0397887*Dm*Power(mTimestep,2))/Jm;
          jacobianMatrix[0][5] = (0.25*Power(mTimestep,2))/Jm;
