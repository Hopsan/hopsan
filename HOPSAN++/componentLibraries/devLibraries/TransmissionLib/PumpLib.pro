...
# *= Means append unique
INCLUDEPATH *= /home/robbr48/Documents/Subversion/HOPSAN++/HopsanCore/include/

# The location of the HopsanCore .dll or .so file, needed to link against when compiling your library
LIBS *= -L/home/robbr48/Documents/Subversion/HOPSAN++/bin
...
HEADERS += \
    code/MechanicSwashPlate.hpp \
    code/HydraulicValvePlate.hpp \
    code/HydraulicPumpPiston.hpp \
