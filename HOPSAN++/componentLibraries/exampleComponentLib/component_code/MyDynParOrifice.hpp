...
#ifndef MYDYNPARORIFICE_H
#define MYDYNPARORIFICE_H
...
class MyDynParOrifice : public ComponentQ
{
private:
...
public:
    ...
    MyDynParOrifice() : ComponentQ()
    {
        ...
        registerDynamicParameter("Kc", "Pressure-Flow Coefficient", "[m^5/Ns]", mKc);
    }
