...
bash.exe -c "patch -p0 < ../discount-mingw-building.patch; patch -p1 < ../discount-2.1.8-msys.patch;  patch -p1 < ../discount-2.1.8-cpp.patch; CC=gcc ./configure.sh --shared; mingw32-make -j4"
