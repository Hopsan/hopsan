...
def generateRootFiles(root_dir):
    ...
    generateHeaderFileForComponentHeaderInclusion(root_dir.dirPath, 'Components.cci', emmcci)
    generateHeaderFileForComponentHeaderInclusion(root_dir.dirPath, 'Components.h', emmheaders)
...
if __name__ == "__main__":
    ...
    if licenseheader == '':
        print('Warning: No license file given')
