...
This signal type component encapsulates an imported FMU for co-simulation or model exchange. All versions of FMI (1, 2 and 3) are supported. Select the FMU file using the "path" parameter.
