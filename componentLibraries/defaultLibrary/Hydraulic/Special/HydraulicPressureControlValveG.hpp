...
Special}/HydraulicPressureControlValveG.nb*/
...
pref)*w*Cos(phi)*dxAbs(p1 - p2)*dxLimit((Av*mTimestep*(p3 - p4 - pref))/(2*Bv \
+ ks*mTimestep + 2*Cq*mTimestep*w*Abs(p1 - p2)*Cos(phi)) - \
