...
pp,Ao,Ab))/Power((Power(Cdt,4)*Power(dh,4)*Power(visc,4) + \
18432*Power(Cdt,4)*Power(del,4)*Power(dh,2)*Power(lo,2)*Power(visc,4) + \
4*Power(del,8)*(Power(dh,8)*Power(pc - pp,2)*Power(rho,2) + \
21233664*Power(Cdt,4)*Power(lo,4)*Power(visc,4)))/(Power(Cdt,4)*Power(del,8)*\
Power(dh,8)),0.25);
          ...
          jacobianMatrix[0][1] = (4*(pc - pp)*(-pc + \
pp)*Power(rho,2)*ifPositive(pc - \
pp,Ao,Ab))/(Power(Cdt,4)*Power((Power(Cdt,4)*Power(dh,4)*Power(visc,4) + \
18432*Power(Cdt,4)*Power(del,4)*Power(dh,2)*Power(lo,2)*Power(visc,4) + \
4*Power(del,8)*(Power(dh,8)*Power(pc - pp,2)*Power(rho,2) + \
21233664*Power(Cdt,4)*Power(lo,4)*Power(visc,4)))/(Power(Cdt,4)*Power(del,8)*\
Power(dh,8)),1.25)) + (2*ifPositive(pc - \
pp,Ao,Ab))/Power((Power(Cdt,4)*Power(dh,4)*Power(visc,4) + \
18432*Power(Cdt,4)*Power(del,4)*Power(dh,2)*Power(lo,2)*Power(visc,4) + \
4*Power(del,8)*(Power(dh,8)*Power(pc - pp,2)*Power(rho,2) + \
21233664*Power(Cdt,4)*Power(lo,4)*Power(visc,4)))/(Power(Cdt,4)*Power(del,8)*\
Power(dh,8)),0.25);
          jacobianMatrix[0][2] = (-4*(pc - pp)*(-pc + \
pp)*Power(rho,2)*ifPositive(pc - \
pp,Ao,Ab))/(Power(Cdt,4)*Power((Power(Cdt,4)*Power(dh,4)*Power(visc,4) + \
18432*Power(Cdt,4)*Power(del,4)*Power(dh,2)*Power(lo,2)*Power(visc,4) + \
4*Power(del,8)*(Power(dh,8)*Power(pc - pp,2)*Power(rho,2) + \
