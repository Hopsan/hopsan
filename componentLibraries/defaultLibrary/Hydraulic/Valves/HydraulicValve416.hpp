...
//==This code has been autogenerated using Compgen==
        ...
        Kspa = pi*Frpa*Ks*Sd*limit(Xpa0 + xvpa,0.,Xpa0 + Xvmax);
        Ksta = pi*Frta*Ks*Sd*limit(Xta0 + xvta,0.,Xta0 + Xvmax);
        Kspb = pi*Frpb*Ks*Sd*limit(Xpb0 + xvpb,0.,Xpb0 + Xvmax);
        Kstb = pi*Frtb*Ks*Sd*limit(Xtb0 + xvtb,0.,Xtb0 + Xvmax);
