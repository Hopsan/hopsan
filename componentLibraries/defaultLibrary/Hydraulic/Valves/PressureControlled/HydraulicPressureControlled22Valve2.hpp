...
//! @date   2014-04-30
//!
//! @brief Contains a pressure controlled hydraulic 2/2 valve of Q-type with default position open
//$Id: HydraulicPressureControlled42Valve.hpp 8139 2015-06-17 12:30:13Z petno25 $

#ifndef HYDRAULICPRESSURECONTROLLED22VALVE2_HPP
#define HYDRAULICPRESSURECONTROLLED22VALVE2_HPP
...
namespace hopsan {
    ...
    class HydraulicPressureControlled22Valve2 : public ComponentQ
    {
    private:
        //Constants
    ...
    public:
        ...
        {
            return new HydraulicPressureControlled22Valve2();
        }
...
#endif // HYDRAULICPRESSURECONTROLLED22VALVE2_HPP
