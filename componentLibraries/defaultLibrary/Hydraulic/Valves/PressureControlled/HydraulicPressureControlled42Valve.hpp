...
//! @date   2014-04-30
//!
//! @brief Contains a pressure controlled hydraulic 4/2 valve of Q-type with default position closed
//$Id$

#ifndef HYDRAULICPRESSURECONTROLLED42VALVE_HPP_INCLUDED
#define HYDRAULICPRESSURECONTROLLED42VALVE_HPP_INCLUDED
...
namespace hopsan {
    ...
    class HydraulicPressureControlled42Valve : public ComponentQ
    {
    private:
        //Constants
    ...
    public:
        ...
        {
            return new HydraulicPressureControlled42Valve();
        }
...
#endif //HYDRAULICPRESSURECONTROLLED42VALVE_HPP_INCLUDED
