...
//!
//! @file ActivityDiagramJoin0.hpp
//! @author Petter Krus <petter.krus@liu.se>
//  co-author/auditor **Not yet audited by a second person**
//! @date Thu 29 Aug 2019 14:48:02
...
ActivityDiagram, ActivityDiagram}/ActivityDiagramJoin0.nb*/

using namespace hopsan;

class ActivityDiagramJoin0 : public ComponentQ
{
private:
     Port *mpPpn1;
     Port *mpPpn2;
...
public:
     ...
     {
        return new ActivityDiagramJoin0();
     }
    ...
    void simulateOneTimestep()
     {
        ...
        //Expressions
        qpn3 = onPositive(-0.5 + spn1*spn2 - spn3);
        qpn1 = -qpn3;
        qpn2 = -qpn3;
...
#endif // ACTIVITYDIAGRAMJOIN0_HPP_INCLUDED
