...
"m", 1.,&mpm3PositionLimitNeg);
        //Add outputVariables to the component
            ...
            addOutputVariable("fc12","friction force between M1 and \
M2","m",0.,&mpfc12);
            addOutputVariable("fc13","friction force between M1 and \
M3","m",0.,&mpfc13);
...
ulomb) + mTimestep*limit((-2*bfc*m1Mass*m3Mass*(vm1 + vm3))/((m1Mass + \
m3Mass)*mTimestep),-m12FrictionCoulomb,m12FrictionCoulomb) + \
mTimestep*limit((-2*bfc*m2Mass*m3Mass*(vm2 + vm3))/((m2Mass + \
...
ulomb) - mTimestep*limit((-2*bfc*m1Mass*m3Mass*(vm1 + vm3))/((m1Mass + \
m3Mass)*mTimestep),-m12FrictionCoulomb,m12FrictionCoulomb))/(2*m2Mass + \
m12FrictionViscousCoeff*mTimestep + m2FrictionViscousCoeff*mTimestep);
...
ulomb) - mTimestep*limit((-2*bfc*m2Mass*m3Mass*(vm2 + vm3))/((m2Mass + \
m3Mass)*mTimestep),-m13FrictionCoulomb,m13FrictionCoulomb))/(2*m3Mass + \
m13FrictionViscousCoeff*mTimestep + m3FrictionViscousCoeff*mTimestep);
...
m3Mass)*mTimestep),-m12FrictionCoulomb,m12FrictionCoulomb) + \
limit((-2*bfc*m2Mass*m3Mass*(vm2 + vm3))/((m2Mass + \
m3Mass)*mTimestep),-m13FrictionCoulomb,m13FrictionCoulomb)))/(-2*m1Mass + \
...
limit((-2*bfc*m1Mass*m3Mass*(vm1 + vm3))/((m1Mass + \
m3Mass)*mTimestep),-m12FrictionCoulomb,m12FrictionCoulomb)))/(2*m2Mass + \
(m12FrictionViscousCoeff + m2FrictionViscousCoeff)*mTimestep)) - \
delayedPart[2][1]);
...
limit((-2*bfc*m2Mass*m3Mass*(vm2 + vm3))/((m2Mass + \
m3Mass)*mTimestep),-m13FrictionCoulomb,m13FrictionCoulomb)))/(2*m3Mass + \
(m13FrictionViscousCoeff + m3FrictionViscousCoeff)*mTimestep)) - \
delayedPart[3][1]);
...
(mTimestep*((2*bfc*m1Mass*dxLimit((-2*bfc*m1Mass*vm1)/mTimestep,-m1FrictionCo\
ulomb,m1FrictionCoulomb))/mTimestep - \
(2*bfc*m1Mass*m3Mass*dxLimit((-2*bfc*m1Mass*m3Mass*(vm1 + vm3))/((m1Mass + \
m3Mass)*mTimestep),-m12FrictionCoulomb,m12FrictionCoulomb))/((m1Mass + \
...
(2*bfc*m2Mass*m3Mass*dxLimit((-2*bfc*m2Mass*m3Mass*(vm2 + vm3))/((m2Mass + \
m3Mass)*mTimestep),-m13FrictionCoulomb,m13FrictionCoulomb))/((m2Mass + \
m3Mass)*mTimestep))*dxLimit(limit((mTimestep*vm1)/2. - \
delayedPart[4][1],-m1PositionLimitNeg,-m1PositionLimitPos),-m1PositionLimitNe\
g,-m1PositionLimitPos))/(-2*m1Mass + (m12FrictionViscousCoeff + \
m13FrictionViscousCoeff - m1FrictionViscousCoeff)*mTimestep));
...
(2*bfc*m1Mass*m3Mass*dxLimit((-2*bfc*m1Mass*m3Mass*(vm1 + vm3))/((m1Mass + \
m3Mass)*mTimestep),-m12FrictionCoulomb,m12FrictionCoulomb))/((m1Mass + \
m3Mass)*mTimestep) - (2*bfc*m2Mass*m3Mass*dxLimit((-2*bfc*m2Mass*m3Mass*(vm2 \
+ vm3))/((m2Mass + \
m3Mass)*mTimestep),-m13FrictionCoulomb,m13FrictionCoulomb))/((m2Mass + \
m3Mass)*mTimestep))*dxLimit(limit((mTimestep*vm1)/2. - \
delayedPart[4][1],-m1PositionLimitNeg,-m1PositionLimitPos),-m1PositionLimitNe\
...
m13FrictionViscousCoeff - m1FrictionViscousCoeff)*mTimestep));
          ...
          jacobianMatrix[0][6] = \
-((mTimestep*dxLimit(limit((mTimestep*vm1)/2. - \
delayedPart[4][1],-m1PositionLimitNeg,-m1PositionLimitPos),-m1PositionLimitNe\
g,-m1PositionLimitPos))/(-2*m1Mass + (m12FrictionViscousCoeff + \
m13FrictionViscousCoeff - m1FrictionViscousCoeff)*mTimestep));
...
(2*bfc*m1Mass*m3Mass*dxLimit((-2*bfc*m1Mass*m3Mass*(vm1 + vm3))/((m1Mass + \
m3Mass)*mTimestep),-m12FrictionCoulomb,m12FrictionCoulomb))/((m1Mass + \
m3Mass)*mTimestep))*dxLimit(limit((mTimestep*vm2)/2. - \
delayedPart[5][1],-m2PositionLimitNeg,-m2PositionLimitPos),-m2PositionLimitNe\
...
tionCoulomb)*dxLimit(limit((mTimestep*vm2)/2. - \
delayedPart[5][1],-m2PositionLimitNeg,-m2PositionLimitPos),-m2PositionLimitNe\
g,-m2PositionLimitPos))/(2*m2Mass + (m12FrictionViscousCoeff + \
m2FrictionViscousCoeff)*mTimestep);
          jacobianMatrix[1][2] = \
(2*bfc*m1Mass*m3Mass*dxLimit((-2*bfc*m1Mass*m3Mass*(vm1 + vm3))/((m1Mass + \
m3Mass)*mTimestep),-m12FrictionCoulomb,m12FrictionCoulomb)*dxLimit(limit((mTi\
mestep*vm2)/2. - \
delayedPart[5][1],-m2PositionLimitNeg,-m2PositionLimitPos),-m2PositionLimitNe\
g,-m2PositionLimitPos))/((m1Mass + m3Mass)*(2*m2Mass + \
(m12FrictionViscousCoeff + m2FrictionViscousCoeff)*mTimestep));
...
m2FrictionViscousCoeff)*mTimestep);
          ...
          jacobianMatrix[2][0] = \
(m13FrictionViscousCoeff*mTimestep*dxLimit(limit((mTimestep*vm3)/2. - \
delayedPart[6][1],-m3PositionLimitNeg,-m3PositionLimitPos),-m3PositionLimitNe\
g,-m3PositionLimitPos))/(2*m3Mass + (m13FrictionViscousCoeff + \
m3FrictionViscousCoeff)*mTimestep);
          jacobianMatrix[2][1] = \
(2*bfc*m2Mass*m3Mass*dxLimit((-2*bfc*m2Mass*m3Mass*(vm2 + vm3))/((m2Mass + \
m3Mass)*mTimestep),-m13FrictionCoulomb,m13FrictionCoulomb)*dxLimit(limit((mTi\
mestep*vm3)/2. - \
delayedPart[6][1],-m3PositionLimitNeg,-m3PositionLimitPos),-m3PositionLimitNe\
g,-m3PositionLimitPos))/((m2Mass + m3Mass)*(2*m3Mass + \
(m13FrictionViscousCoeff + m3FrictionViscousCoeff)*mTimestep));
          jacobianMatrix[2][2] = 1 + \
(mTimestep*((2*bfc*m3Mass*dxLimit((-2*bfc*m3Mass*vm3)/mTimestep,-m3FrictionCo\
ulomb,m3FrictionCoulomb))/mTimestep + \
(2*bfc*m2Mass*m3Mass*dxLimit((-2*bfc*m2Mass*m3Mass*(vm2 + vm3))/((m2Mass + \
m3Mass)*mTimestep),-m13FrictionCoulomb,m13FrictionCoulomb))/((m2Mass + \
...
//==This code has been autogenerated using Compgen==
          ...
          xp2 = -xm2;
          xp3 = -xm3;
          fc12 = -(m12FrictionViscousCoeff*(vm1 + vm2)) + \
limit((-2*bfc*m1Mass*m3Mass*(vm1 + vm3))/((m1Mass + \
m3Mass)*mTimestep),-m12FrictionCoulomb,m12FrictionCoulomb);
          fc13 = -(m13FrictionViscousCoeff*(vm1 + vm3)) + \
limit((-2*bfc*m2Mass*m3Mass*(vm2 + vm3))/((m2Mass + \
