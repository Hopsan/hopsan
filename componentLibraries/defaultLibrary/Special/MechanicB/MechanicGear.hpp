...
#ifndef MECHANICGEAR_HPP_INCLUDED
#define MECHANICGEAR_HPP_INCLUDED
...
//!
//! @file MechanicGear.hpp
//! @author Petter Krus <petter.krus@liu.se>
//! @date Fri 25 Apr 2014 16:57:35
//! @brief This is a gear
//! @ingroup MechanicComponents
//!
//==This code has been autogenerated using Compgen==
//from 
/*{, C:, HopsanTrunk, componentLibraries, defaultLibrary, Special, \
Mechanic}/MechanicGear.nb*/

using namespace hopsan;

class MechanicGear : public ComponentQ
{
private:
     double Jg;
     double Bg;
...
2*Jg*wmr2 + Bg*mTimestep*wmr2 + mTimestep*myfric*tormr1*limit((wmr1 + \
gearRatio*wmr2)/wc,-1.,1.))/(2*Jg + Bg*mTimestep);
    ...
    void simulateOneTimestep()
     {
        ...
        for(iter=1;iter<=mNoiter;iter++)
        {
         ...
         //Differential-algebraic system of equation parts
          ...
          systemEquations[0] =wmr2 + (mTimestep*(-(gearRatio*tormr1) + tormr2 \
+ myfric*tormr1*limit((wmr1 + gearRatio*wmr2)/wc,-1.,1.)))/(2*Jg + \
Bg*mTimestep) + delayedPart[1][1];
          systemEquations[1] =thetamr2 - (mTimestep*wmr2)/2. + \
delayedPart[2][1];
          systemEquations[2] =thetamr1 + (gearRatio*mTimestep*wmr2)/2. + \
delayedPart[3][1];
          systemEquations[3] =-cmr1 + tormr1 + gearRatio*wmr2*Zcmr1;
          systemEquations[4] =-cmr2 + tormr2 - wmr2*Zcmr2;

          //Jacobian matrix
          jacobianMatrix[0][0] = 1 + \
(gearRatio*mTimestep*myfric*tormr1*dxLimit((wmr1 + \
gearRatio*wmr2)/wc,-1.,1.))/((2*Jg + Bg*mTimestep)*wc);
          jacobianMatrix[0][1] = 0;
          jacobianMatrix[0][2] = 0;
          jacobianMatrix[0][3] = (mTimestep*(-gearRatio + myfric*limit((wmr1 \
+ gearRatio*wmr2)/wc,-1.,1.)))/(2*Jg + Bg*mTimestep);
          jacobianMatrix[0][4] = mTimestep/(2*Jg + Bg*mTimestep);
          ...
          jacobianMatrix[3][0] = gearRatio*Zcmr1;
...
#endif // MECHANICGEAR_HPP_INCLUDED
