...
//==This code has been autogenerated using Compgen==
        //InitialExpressions
        cmr1 = tormr1 - (2*Ks*mTimestep*wmr1)/(1 - alpha);
        cmr2 = tormr2 - (2*Ks*mTimestep*wmr2)/(1 - alpha);
        cmr1f = tormr1;
        cmr2f = tormr2;

        //LocalExpressions
        cmr10 = cmr2 + (4*Ks*mTimestep*wmr2)/(1 - alpha);
        cmr20 = cmr1 + (4*Ks*mTimestep*wmr1)/(1 - alpha);
    ...
    void simulateOneTimestep()
     {
        ...
        cmr20 = cmr1 + (4*Ks*mTimestep*wmr1)/(1 - alpha);
          ...
          Zcmr1 = (2*Ks*mTimestep)/(1 - alpha);
          Zcmr2 = (2*Ks*mTimestep)/(1 - alpha);
