...
//    //^^^
    ...
    pComponentFactory->registerCreatorFunction("Hydraulic42Valve2", Hydraulic42Valve2::Creator);
    ...
    pComponentFactory->registerCreatorFunction("HydraulicPistonAckumulator", HydraulicPistonAckumulator::Creator);
    ...
    pComponentFactory->registerCreatorFunction("HydraulicSpringLoadedPistonC", HydraulicSpringLoadedPistonC::Creator);
