...
delayedPart[1][1],0.001,0.999))/(7200.*capacity);
          ...
          jacobianMatrix[2][0] = (5*Power(2,1 + \
kappa)*Power(e,(10*soc)/kappa)*(-1 + \
Power(e,(10*soc)/kappa))*unom*Power(asin(limit(soc,1.e-9,0.9999)),kappa))/(Po\
wer(1 + Power(e,(10*soc)/kappa),2)*kappa) - (5*Power(2,1 + \
kappa)*Power(e,(10*soc)/kappa)*unom*Power(asin(limit(soc,1.e-9,0.9999)),kappa\
))/((1 + Power(e,(10*soc)/kappa))*kappa) - (Power(2,kappa)*(-1 + \
