...
//void LogDataHandler::exportToPlo(const QString &rFilePath, QList<SharedVectorVariableT> variables, int version) const
//{
...
//void LogDataHandler::exportToCSV(const QString &rFilePath, const QList<SharedVectorVariableT> &rVariables) const
//{
//    QFile file;
//    file.setFileName(rFilePath);   //Create a QFile object
//    if (!file.open(QIODevice::WriteOnly | QIODevice::Text))
...
//SharedVectorVariableT LogDataHandler::insertNewHopsanVariable(const QString &rDesiredname, VariableTypeT type, const int gen)
//{
...
//SharedVectorVariableT LogDataHandler::insertNewHopsanVariable(SharedVectorVariableT pVariable, const int gen)
//{
...
//SharedVectorVariableT LogDataHandler::getHopsanVariable(const QString &rName, const int generation) const
//{
//    // Find the data variable
//    LogDataMapT::const_iterator dit = mLogDataMap.find(rName);
//    if (dit != mLogDataMap.end())
//    {
//        return SharedVectorVariableT(dit.value(), dit.value()->getDataGeneration(generation));
//    }
//    return SharedVectorVariableT();
//}
...
//{
//    SharedVectorVariableT data = getHopsanVariable(fullVarName, gen);
//    if(data)
//    {
...
//{
//    SharedVectorVariableT xdata = getHopsanVariable(rFullNameX, gen);
//    SharedVectorVariableT ydata = getHopsanVariable(rFullNameY, gen);
//    if (xdata && ydata)
//    {
...
//QList<SharedVectorVariableT> LogDataHandler::getAllNonAliasVariablesAtRespectiveNewestGeneration()
//{
...
//QList<SharedVectorVariableT> LogDataHandler::getAllNonAliasVariablesAtGeneration(const int generation) const
//{
...
//QList<SharedVectorVariableT> LogDataHandler::getAllVariablesAtRespectiveNewestGeneration()
//{
//    return getAllVariablesAtGeneration(-1);
//}

//QList<SharedVectorVariableT> LogDataHandler::getAllVariablesAtGeneration(const int gen)
//{
//    QList<SharedVectorVariableT> dataList;
...
//        if (pData)
//        {
//            dataList.append(SharedVectorVariableT(dit.value(), pData));
//        }
//    }
//    return dataList;
//}
...
//QList<SharedVectorVariableT> LogDataHandler::getImportedVariablesForFile(const QString &rFileName)
//{
...
//void LogDataHandler::rememberIfImported(SharedVectorVariableT data)
//{
...
//SharedVectorVariableT LogDataHandler::insertVariable(SharedVectorVariableT pVariable, QString keyName, int gen)
//{
...
//    rememberIfImported(SharedVectorVariableT(pDataContainer,pVariable));

//    // Make the variable remember that this logdatahandler is its parent (creator)
//    pVariable->mpParentLogDataHandler = this;

//    return SharedVectorVariableT(pDataContainer, pVariable);
//}
