...
//    SharedVectorVariableT getHopsanVariable(const QString &rName, const int generation) const;
...
//private:
//    typedef QMap< QString, QMultiMap<QString, SharedVectorVariableT> > ImportedLogDataMapT;
