...
//    void addAliasVariable(SharedVectorVariableT data);
...
//        cname = data->getFullVariableName();
//    }
...
//        mFullVariableItemMap.insert(data->getComponentName(), pComponentItem);
//    }
...
//void VariableTree::addAliasVariable(SharedVectorVariableT data)
//{
...
//    {
//        QList<SharedVectorVariableT> vars = mpLogDataHandler->getImportedVariablesForFile(importedFileNames[f]);
//        if (!vars.isEmpty())
//        {
...
//void PlotWidget::setLogDataHandler(QPointer<LogDataHandler2> pLogDataHandler)
//{
...
//LogDataHandler2 *PlotWidget::getLogDataHandler()
//{
