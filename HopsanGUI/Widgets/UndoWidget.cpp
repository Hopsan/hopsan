...
QString UndoWidget::translateTag(QString tag)
{
    ...
    tagMap.insert("addedsubsystem",             "Added Subsystem");
    tagMap.insert("deletedsubsystem",           "Deleted Subsystem");
    tagMap.insert("addedconditionalsubsystem",  "Added Conditional Subsystem");
    tagMap.insert("deletedconditionalsubsystem","Deleted Conditional Subsystem");
