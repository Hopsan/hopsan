...
enum SimulationWorkeObjectEnumT {LocalSWO, RemoteSWO, DCPManagerSWO, DCPSlaveSWO};
enum class SimulationState {Initialize, Simulate, RemoteSimulate, DcpMasterSimulate, DcpSlaveSimulate, Finalize, Done};
