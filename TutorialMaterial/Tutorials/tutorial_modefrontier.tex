...
Putting the objective function in Hopsan is not always possible (or desirable). In this case it is necessary to export the data to modeFRONTIER instead, so that the calculation can be made there.
...
If everything was successful, the optimization should work and give reasonable results. It should, however, be slower with this method, due to the large amount of data being exchanged between the programs.
\end{tutenumerate}
