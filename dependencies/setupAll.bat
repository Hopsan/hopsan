...
REM First base libraries (order is important, zlib->libzip->xerces)
start /wait cmd /c setupZlib.bat
start /wait cmd /c setupLibzip.bat
start /wait cmd /c setupXerces.bat

REM DCPLib depends on xerces and libzip
start /wait cmd /c setupDCPLib.bat
start /wait cmd /c setupDiscount.bat
start /wait cmd /c setupFmi4c.bat
REM HDF5 depends on zlib and libzip
