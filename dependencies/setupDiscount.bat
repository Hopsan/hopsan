...
cmake -G %HOPSAN_BUILD_CMAKE_GENERATOR% -DBUILD_SHARED_LIBS=ON -DCMAKE_BUILD_TYPE=Release -DDISCOUNT_ONLY_LIBRARY=ON %export_symbols_arg% -DCMAKE_INSTALL_PREFIX=%installdir% %codedir%\cmake
