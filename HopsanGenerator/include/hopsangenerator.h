...
extern "C" {
    ...
    HOPSANGENERATOR_DLLAPI bool callFmuExportGenerator(const char* outputPath, void* pHopsanSystem, const char* hopsanInstallPath, const char* compilerPath, int version=2, int architecture=64, messagehandler_t messageHandler=0, void* pMessageObject=0);
